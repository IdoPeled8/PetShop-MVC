...
public class PetShopContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Animal>().HasData(
            ...
            new Animal { AnimalId = 11, Name = "Trip", Age = 11, ImageName = "trip.jpeg", Description = "I am Ido's dog. Trip is a friendly dog who loves to play fetch with his owner Ido. He is loyal and always happy to see his family.", CategoryId = 1 },
